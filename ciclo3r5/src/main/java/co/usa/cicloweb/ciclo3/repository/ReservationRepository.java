...
import co.usa.cicloweb.ciclo3.model.Client;//ojo
import java.util.List;
import java.util.Optional;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Repository;
//import org.springframework.data.repository.CrudRepository;
import co.usa.cicloweb.ciclo3.repository.crud.ReservationCrudRepository;
...
public class ReservationRepository {
    ...
    public List<Reservation> ReservacionStatusRepositorio (String status){
     ...
     public List<CountClient> getClientesRepositorio(){
         ...
         }//En caso de fallar corregir la clase CountClient ya que esta tomando de referencia el paquete modelo client.java
         return res;
     }
}
